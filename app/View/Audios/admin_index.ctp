<div class="col-md-9 col-xs-12">
	<table class="table table-striped">
		<tr>
			...
			<th><?php echo $this->Paginator->sort('random_name', __('Random name')); ?></th>
		...
		<?php foreach ($data as $u => $k): ?>
			...
			<tr>
				...
				<td>
					<?php echo $v['random_name']; ?>
				</td>
				<td>
					<?php echo $k['User']['email']; ?>
				</td>
				<td class="action">
					<div class="btn-group">
						<?php
						...
						<?php
							echo $this->Html->link(
								...
								__('Are you sure you wish to delete the audio file : ') . $v['name'] . ' ?'
							);
						?>
					</div>
				</td>
				...
				<li>
					<?php 
						echo $this->Form->create('Audio', array(
							'url' => array_merge(array('controller' => 'audios', 'action' => 'admin_index'), $this->params['pass']),
							'class' => 'form-inline'
						));
